...
import './mobile/utils/sharedImport'; // Even if unused here, this keeps consistency
import './mobile/utils/firebase'; // Bootstraps Firebase configuration (warns if not configured)
